...
def main(
    ...
    # Rename 'griffin_jax' directory to `package_dir_name`.
    if not dry_run:
        (REPO_BASE / "griffin_jax").replace(REPO_BASE / package_dir_name)
    else:
        print(f"Renaming 'griffin_jax' directory to '{package_dir_name}'")
